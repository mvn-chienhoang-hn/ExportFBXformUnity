...
namespace UnityEditor.Formats.Fbx.Exporter
{
    ...
    public sealed class ModelExporter : System.IDisposable
    {
        ...
        internal const float UnitScaleFactor = 1000f;
        ...
        /// </summary>
        const string UniqueNameFormat = "{0} {1}";
        ...
        public int CountChildGameObject(GameObject fromGameObject, string withName) {
            int count = 0;
        ...
        private FbxNode CreateFbxNode(GameObject unityGo, FbxScene fbxScene)
        {
            ...
            string tmpUniqueName = unityGo.name;
        //    if (unityGo.transform.parent != null && CountChildGameObject(unityGo.transform.parent.gameObject, tmpUniqueName) > 1)
        //     {
        //         tmpUniqueName = GetUniqueFbxNodeName(fbxName);
        //     }

            
            FbxNode fbxNode = FbxNode.Create(fbxScene, tmpUniqueName);
            ...
            Dictionary<GameObject, IExportData> exportData)
        {
            ...
            try
            {
                ...
                var tempFileName = Path.GetFileNameWithoutExtension(Path.GetRandomFileName()) + " " + lastFileName;
